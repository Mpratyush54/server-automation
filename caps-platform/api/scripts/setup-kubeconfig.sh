#!/bin/bash
# CAPS Platform - Kubeconfig Setup Script
# Run this on the K8s master node to set up kubeconfig for CAPS Platform
...
echo "=== CAPS Platform Kubeconfig Setup ==="
...
echo "✓ Namespace caps-platform ready"
